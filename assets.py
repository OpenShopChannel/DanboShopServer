...
def serve_slug_icon(slug: str) -> Response:
    ...
    if os.path.isfile(filename):
        return send_file(filename, mimetype='image/png', download_name=slug+".png")

    # Fallback icon
    return send_file("static/images/missing-app-icon.png", mimetype='image/png', download_name=slug+".png")
...
def serve_slug_file(slug: str, file_type: FileTypes):
    ...
    if os.path.isfile(filename):
        return send_file(filename, download_name=slug+"."+file_type.value)
    else:
        abort(404)
